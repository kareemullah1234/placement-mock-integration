...
try:
    ...
    SimpleDocTemplate = Paragraph = Spacer = Table = TableStyle = ListFlowable = ListItem = None
    colors = getSampleStyleSheet = A4 = Color = None
...
INTERVIEW_ANALYSIS_MODEL = getattr(settings, 'OPENROUTER_CONFIG', {}).get('MODEL', 'deepseek/deepseek-r1-0528')
...
def download_student_report(request, interview_id):
    ...
    if not REPORTLAB_AVAILABLE:
        return HttpResponse("PDF report generation requires 'reportlab'. Install it and retry.", status=503)
